...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='leadchatsession',
            index=models.Index(fields=['lead', '-last_activity_at'], name='leads_leadc_lead_id_f3a982_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='leadmessage',
            index=models.Index(fields=['direction', 'channel'], name='leads_leadm_directi_0a637a_idx'),
        ),
        migrations.AddIndex(
            model_name='leadmessage',
            index=models.Index(fields=['chat_session', 'created_at'], name='leads_leadm_chat_se_ef200f_idx'),
        ),
        migrations.AddIndex(
            model_name='leadmessage',
            index=models.Index(fields=['message_id'], name='leads_leadm_message_119988_idx'),
        ),
        migrations.AddIndex(
            model_name='leadmessage',
            index=models.Index(fields=['in_reply_to'], name='leads_leadm_in_repl_794ca6_idx'),
        ),
    ]
